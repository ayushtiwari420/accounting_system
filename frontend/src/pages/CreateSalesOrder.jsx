      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-2xl flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            />
            <label htmlFor="autoInvoice" className="text-xs font-extrabold text-emerald-950 cursor-pointer">
              Auto-Issue Customer Invoice & Post GL Journal Entry (Updates Profit & Loss Immediately)
            </label>
          </div>
          <span className="text-[10px] font-extrabold bg-emerald-100 text-emerald-900 px-2 py-0.5 rounded border border-emerald-300 uppercase">
            Recommended
          </span>
        </div>
